...
public class TechnologyDataBaseHelper extends SQLiteOpenHelper {

	private static final String DB_NAME = "Technology";

	public TechnologyDataBaseHelper(Context context) {
	...
	public void onCreate(SQLiteDatabase db) {
		db.execSQL("CREATE TABLE "
				+ DB_NAME
				+ " (TechnologyID INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, Name TEXT);");
